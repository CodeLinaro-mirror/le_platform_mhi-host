...
#define MHI_PM_BOOT_FAILURE		BIT(8)
#define MHI_PM_SYS_ERR_DETECT		BIT(9)
#define MHI_PM_SYS_ERR_PROCESS		BIT(10)
...
#define MHI_REG_ACCESS_VALID(pm_state) ((pm_state & (MHI_PM_POR | MHI_PM_M0 | \
		...
		MHI_PM_SHUTDOWN_PROCESS | MHI_PM_FW_DL_ERR | MHI_PM_BOOT_FAILURE)))
...
/* MHI TSC Timesync offsets */
#define TSC_TIMESYNC_TIME_LOW_OFFSET TIMESYNC_TIME_LOW_OFFSET
#define TSC_TIMESYNC_TIME_HIGH_OFFSET TIMESYNC_TIME_HIGH_OFFSET
#define TSC_TIMESYNC_CAP_ID (4)
